 <template>
     <div>
       ...
       <header class="site-navbar py-md-1 " role="banner">
            <div class="container">
              <div class="row align-items-center">
                ...
                <div class="col-6 col-xl-2 text-right d-block">
                  ...
                  <div class="d-inline-block d-md-none ml-md-0 mr-auto py-3" style="position: relative; top: 3px;">
                      <a @click="toggle()" ref="open" class="site-menu-toggle js-menu-toggle text-white"><span class="icon-menu h3"></span></a>
           ...
           <div class="overlay2" id="overlay" ref="overlay" @click="cancel()" ></div>
