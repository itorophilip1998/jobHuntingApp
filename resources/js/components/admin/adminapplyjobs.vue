...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <router-link to="/dashboard" title="Go to Home" class="tip-bottom" style="padding-right:2px;color:royalblue"><i class="icon-home"></i>Home</router-link> / Apply Jobs Mail</div>
  </div>
    ...
    <div class="quick-actions_homepage">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Apply Jobs Mail Data table</h5>
          </div>
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <p>
                  <h6><i class="fa fa-book" aria-hidden="true"></i> <b>Mail Content</b></h6>
                  {{singleuser.content}}
             </p>
              <p>
                  <h6><i class="fa fa-envelope-open" aria-hidden="true"></i> <b>Sent To</b></h6>
                  {{singleuser.to}}
             </p>
              <p>
                  <h6><i class="fa fa-address-book" aria-hidden="true"></i> <b>Cv Attachment</b></h6>
                  {{singleuser.attachment}}
             </p>
              <p>
...
<script>
    ...
    mounted() {
     ...
     methods: {
        ...
        deletejob(data)
        {
            axios.delete(`/admin/deletecontactus/${data.id}`)
                .then((res) => {
                 this.loadUser();
        ...
        loadUser(page=1) {
        axios.get('/admin/alljobmails?page=' + page)
                .then((res) => {
