...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <router-link to="/dashboard" title="Go to Home" class="tip-bottom" style="padding-right:2px;color:royalblue"><i class="icon-home"></i>Home</router-link> / Contact Us Mail</div>
  </div>
    ...
    <div class="quick-actions_homepage">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Contact Us Mail Data table</h5>
          </div>
...
<script>
    ...
    mounted() {
     ...
     methods: {
        ...
        loadUser(page=1) {
        axios.get('/admin/allcontactmails?page=' + page)
                .then((res) => {
