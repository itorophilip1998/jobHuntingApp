...
<body>
    ...
    <div class="container box">
        ...
        @endif
        <form action="{{url('jobcv')}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label for="Enter your email">Attachment:</label>
                <input type="file" name="attachment" id="" class="form-control" placeholder="" aria-describedby="helpId">
            </div>
            <div class="form-group">
